...
alter table ExaminationQuestions
   add constraint FK_EXAMINAT_EQ_EP_EXAMINAT foreign key (EQ_Paper)
...
alter table Questions
   add constraint FK_QUESTION_Q_QC_QUESTION foreign key (Q_Classify)
