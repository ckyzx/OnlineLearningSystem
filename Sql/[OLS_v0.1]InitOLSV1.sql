...
CREATE DATABASE OLS ON
	(
		...
		FILENAME='F:\SQLSERVER2008DATA\OLS.mdf',
		SIZE=3,
		MAXSIZE=UNLIMITED,
		FILEGROWTH=200MB
	) LOG ON
	(
		...
		FILENAME='F:\SQLSERVER2008DATA\OLS_log.ldf',
		SIZE=1,
		MAXSIZE=UNLIMITED,
		FILEGROWTH=200MB
	)
...
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (79, 79, 11, N'试卷模板列表，学员后台', N'ExaminationPaperTemplate', N'ListStudent', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
...
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (81, 81, 11, N'查询试卷模板，学员后台', N'ExaminationPaperTemplate', N'ListDataTablesAjaxStudent', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
...
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (103, 103, 7, N'试题分类列表', N'QuestionClassify', N'List', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (104, 104, 7, N'查询试题分类', N'QuestionClassify', N'ListDataTablesAjax', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (105, 105, 7, N'新建试题分类', N'QuestionClassify', N'Create', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (106, 106, 7, N'添加试题分类', N'QuestionClassify', N'Create', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (107, 107, 7, N'查看试题分类', N'QuestionClassify', N'Edit', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (108, 108, 7, N'修改试题分类', N'QuestionClassify', N'Edit', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (109, 109, 7, N'回收试题分类', N'QuestionClassify', N'Recycle', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (110, 110, 7, N'恢复试题分类', N'QuestionClassify', N'Resume', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (111, 111, 7, N'删除试题分类', N'QuestionClassify', N'Delete', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (112, 112, 7, N'检查试题分类名称', N'QuestionClassify', N'DuplicateName', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (113, 113, 9, N'开始考试任务', N'ExaminationTask', N'StartTask', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
INSERT [dbo].[Permissions] ([P_Id], [P_AutoId], [PC_Id], [P_Name], [P_Controller], [P_Action], [P_Remark], [P_AddTime]) VALUES (114, 114, 9, N'结束考试任务', N'ExaminationTask', N'StopTask', NULL, CAST(0x079DAEB04D8BAB3A0B AS DateTime2))
...
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 103)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 104)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 105)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 106)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 107)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 108)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 109)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 110)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 111)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 112)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 113)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (1, 114)
...
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 46)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 47)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 79)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 81)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 89)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 90)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 93)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 94)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 95)
INSERT [dbo].[Role_Permission] ([R_Id], [P_Id]) VALUES (@i, 96)

UPDATE Roles SET 
R_Permissions = '[46,47,79,81,89,90,93,94,95,96]',
R_PermissionCategories = '[2]'
WHERE R_Id = @i
