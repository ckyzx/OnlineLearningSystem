    ...
    function validateData() {
        ...
        if (0 != autoType) {
            ...
            if (ratioNumber > 1) {
                ...
                $('<div class="custom-validation-error">' +
                    '<div class="cl"></div>' +
                    '<span class="field-validation-error">' +
                    '<span htmlfor="ETT_AutoRatio" generated="true" class="">出题比例必须小于100%</span>' +
                    '</span>' +
                    '<div>').appendTo(container);
        ...
        if (1 == statisticType && totalScore % 10 != 0) {
            ...
            $('<div class="custom-validation-error">' +
                '<div class="cl"></div>' +
                '<span class="field-validation-error">' +
                '<span htmlfor="ETT_TotalScore" generated="true" class="">出题总分必须为10的倍数</span>' +
                '</span>' +
            ...
            $('<div class="custom-validation-error">' +
                '<div class="cl"></div>' +
                '<span class="field-validation-error">' +
                '<span htmlfor="ETT_TotalNumber" generated="true" class="">出题总数必须为10的倍数</span>' +
                '</span>' +
