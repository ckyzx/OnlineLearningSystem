    ...
    jQuery.ui || (function($) {
        ...
        if (isFF2) {
            ...
            $.attr = function(elem, name, value) {
                ...
                return (name == 'role' ? (set ? attr.call(this, elem, name, "wairole:" + value) : (attr.apply(this, arguments) || "").replace(ariaRole, "")) : (ariaState.test(name) ? (set ? elem.setAttributeNS(ariaNS,
                    name.replace(ariaState, "aaa:"), value) : attr.call(this, elem, name.replace(ariaState, "aaa:"))) : attr.apply(this, arguments)));
            };
    ...
    (function($) {
        $.fn.extend({
            ...
            jtimepicker: function(options) {
                ...
                var defaults = {
                    clockIcon: '/Contents/lib/jtimepicker/images/icon_clock_1.gif',
                    orientation: 'horizontal',
                    // set hours
                    hourCombo: 'hourcombo',
                    hourMode: 24,
