...
create table ExaminationTasks (
   ...
   ET_StartDate         DateTime             null,
   ET_EndDate           DateTime             null,
   ET_Remark            varchar(200)         null,
   ET_AddTime           DateTime             null,
...
create table Questions (
   ...
   Q_Type               smallint             null,
   Q_Classify           int                  null,
   Q_Content            varchar(5000)        null,
   Q_ModelAnswer        varchar(5000)        null,
   Q_DifficultyCoefficient tinyint              null,
   Q_Remark             varchar(200)         null,
   Q_AddTime            DateTime             null,
